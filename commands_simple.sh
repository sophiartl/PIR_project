...
LOG_N=14 D=131072 go test -bench PirSingle -timeout 0 -run=^$ > bench-14_16KB &&
LOG_N=14 D=262144 go test -bench PirSingle -timeout 0 -run=^$ > bench-14_32KB  &&
LOG_N=14 D=524288 go test -bench PirSingle -timeout 0 -run=^$ > bench-14_64KB &&
LOG_N=14 D=1048576 go test -bench PirSingle -timeout 0 -run=^$ > bench-14_128KB &&
LOG_N=14 D=2097152 go test -bench PirSingle -timeout 0 -run=^$ > bench-14_256KB &&
...
LOG_N=15 D=131072 go test -bench PirSingle -timeout 0 -run=^$ > bench-15_16KB &&
LOG_N=15 D=262144 go test -bench PirSingle -timeout 0 -run=^$ > bench-15_32KB  &&
LOG_N=15 D=524288 go test -bench PirSingle -timeout 0 -run=^$ > bench-15_64KB &&
LOG_N=15 D=1048576 go test -bench PirSingle -timeout 0 -run=^$ > bench-15_128KB &&
...
LOG_N=19 D=32768 go test -bench PirSingle -timeout 0 -run=^$ > bench-19_4KB  &&
...
LOG_N=20 D=32768 go test -bench PirSingle -timeout 0 -run=^$ > bench-20_4KB  &&
...
LOG_N=21 D=32768 go test -bench PirSingle -timeout 0 -run=^$ > bench-21_4KB  &&
...
LOG_N=22 D=32768 go test -bench PirSingle -timeout 0 -run=^$ > bench-22_4KB  &&
